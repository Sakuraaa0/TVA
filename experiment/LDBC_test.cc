...
{
    // tests/experiments/t_mgBench_test.sh
    ...
    ctgraph::VertexId_t VComment_Tag_HAS_TAG = 152000;
    ...
    ctgraph::VertexId_t VComment_Post_REPLY_OF = 152000;
    ...
    ctgraph::VertexId_t VComment_Comment_REPLY_OF = 152000;
    ...
    ctgraph::VertexId_t VPerson_Comment_HasCreator = 1600;
    ...
    ctgraph::VertexId_t VForum_Tag_HAS_TAG = 14000;
    ...
    ctgraph::VertexId_t VPerson_Tag_HAS_INTEREST = 1600;
    ...
    ctgraph::VertexId_t VPerson_Person_KNOWS = 1600;
    ...
    ctgraph::VertexId_t VPerson_Comment_LIKES = 1600;
    ...
    ctgraph::VertexId_t VPerson_Post_LIKES = 1600;
    ...
    ctgraph::VertexId_t VPerson_Organisation_WORK_AT = 1600;
    ...
    ctgraph::VertexId_t VPost_Tag_HAS_TAG = 150000;
    ...
    auto duration_org = std::chrono::duration_cast<std::chrono::milliseconds>(end_time_org - start_time_org);
    std::cout << "Organisationload data time " << duration_org.count() << " ms" << std::endl;
    std::cout << "Organisationmem cost: " << (end_memory_org - start_memory_org) / 1024.0 << " MB" << std::endl;
    ...
    std::cout << "Placeload data time " << duration_place.count() << " ms" << std::endl;
    std::cout << "Placemem cost: " << (end_memory_place - start_memory_place) / 1024.0 << " MB" << std::endl;
    ...
    auto duration_tag = std::chrono::duration_cast<std::chrono::milliseconds>(end_time_tag - start_time_tag);
    std::cout << "Tagload data time " << duration_tag.count() << " ms" << std::endl;
    std::cout << "Tagmem cost: " << (end_memory_tag - start_memory_tag) / 1024.0 << " MB" << std::endl;

    // Initial_tagclass
    std::cout << "TagClass..." << std::endl;
    ...
    auto duration_tagclass =
        std::chrono::duration_cast<std::chrono::milliseconds>(end_time_tagclass - start_time_tagclass);
    std::cout << "TagClassload data time " << duration_tagclass.count() << " ms" << std::endl;
    std::cout << "TagClassmem cost: " << (end_memory_tagclass - start_memory_tagclass) / 1024.0 << " MB" << std::endl;

    // Initial_comment_post
    std::cout << "Comment Post..." << std::endl;
    ...
    auto duration_cp = std::chrono::duration_cast<std::chrono::milliseconds>(end_time_cp - start_time_cp);
    std::cout << "Comment Postload data time " << duration_cp.count() << " ms" << std::endl;
    std::cout << "Comment Postmem cost: " << (end_memory_cp - start_memory_cp) / 1024.0 << " MB" << std::endl;

    // Initial_forum
    std::cout << "Forum..." << std::endl;
    ...
    auto duration_forum = std::chrono::duration_cast<std::chrono::milliseconds>(end_time_forum - start_time_forum);
    std::cout << "Forumload data time " << duration_forum.count() << " ms" << std::endl;
    std::cout << "Forummem cost: " << (end_memory_forum - start_memory_forum) / 1024.0 << " MB" << std::endl;
    ...
    auto duration_person = std::chrono::duration_cast<std::chrono::milliseconds>(end_time_person - start_time_person);
    std::cout << "Person load data time " << duration_person.count() << " ms" << std::endl;
    std::cout << "Person mem cost: " << (end_memory_person - start_memory_person) / 1024.0 << " MB" << std::endl;
    ...
    auto duration_post = std::chrono::duration_cast<std::chrono::milliseconds>(end_time_post - start_time_post);
    std::cout << "Post load data time " << duration_post.count() << " ms" << std::endl;
    std::cout << "Post mem cost: " << (end_memory_post - start_memory_post) / 1024.0 << " MB" << std::endl;
    ...
    std::cout << "all load time: " << duration.count() << " ms" << std::endl;
    ...
    auto duration_update = std::chrono::duration_cast<std::chrono::milliseconds>(end_time_update - start_time_update);
    std::cout << "update time: " << duration_update.count() << " ms" << std::endl;
    std::cout << "uodate mem cost: " << (end_memory_update - start_memory_update) / 1024.0 << " MB" << std::endl;
    ...
    std::ifstream is1_file("/workspace/dataset/ldbc/small/temporal_query/IS1_cypher.txt");
    std::string is1_line;

    if (!is1_file.is_open())
    {
        std::cerr << "cannot openIS1_cypher.txt" << std::endl;
    }
    else
    {
    ...
    if (!is1_queries.empty())
    {
        ...
        auto duration_is1 = std::chrono::duration_cast<std::chrono::milliseconds>(end_time_is1 - start_time_is1);

        std::cout << "IS1query num: " << is1_queries.size() << std::endl;
        std::cout << "IS1exec time: " << duration_is1.count() << " ms" << std::endl;
        std::cout << "IS1avg query time: " << (double)duration_is1.count() / is1_queries.size() << " ms" << std::endl;
        std::cout << "IS1mem cost: " << (end_memory_is1 - start_memory_is1) / 1024.0 << " MB" << std::endl;
    }
    else
    {
        std::cout << "IS1dont have any query" << std::endl;
    }
    ...
    std::ifstream is2_file("/workspace/dataset/ldbc/small/temporal_query/IS2_cypher.txt");
    std::string is2_line;

    if (!is2_file.is_open())
    {
        std::cerr << "cannot openIS2_cypher.txt" << std::endl;
    }
    else
    {
    ...
    if (!is2_queries.empty())
    {
        ...
        auto duration_is2 = std::chrono::duration_cast<std::chrono::milliseconds>(end_time_is2 - start_time_is2);

        std::cout << "IS2query num: " << is2_queries.size() << std::endl;
        std::cout << "IS2exec time: " << duration_is2.count() << " ms" << std::endl;
        std::cout << "IS2avg query time: " << (double)duration_is2.count() / is2_queries.size() << " ms" << std::endl;
        std::cout << "IS2mem cost: " << (end_memory_is2 - start_memory_is2) / 1024.0 << " MB" << std::endl;
    }
    else
    {
        std::cout << "IS2dont have any query" << std::endl;
    }
    ...
    std::ifstream is3_file("/workspace/dataset/ldbc/small/temporal_query/IS3_cypher.txt");
    std::string is3_line;

    if (!is3_file.is_open())
    {
        std::cerr << "cannot openIS3_cypher.txt" << std::endl;
    }
    else
    {
        while (std::getline(is3_file, is3_line))
        {
            // 第一行包含MATCH语句和person id
    ...
    if (!is3_queries.empty())
    {
        ...
        auto duration_is3 = std::chrono::duration_cast<std::chrono::milliseconds>(end_time_is3 - start_time_is3);

        std::cout << "IS3query num: " << is3_queries.size() << std::endl;
        std::cout << "IS3exec time: " << duration_is3.count() << " ms" << std::endl;
        std::cout << "IS3avg query time: " << (double)duration_is3.count() / is3_queries.size() << " ms" << std::endl;
        std::cout << "IS3mem cost: " << (end_memory_is3 - start_memory_is3) / 1024.0 << " MB" << std::endl;
    }
    else
    {
        std::cout << "IS3dont have any query" << std::endl;
    }
    ...
    std::ifstream is4_file("/workspace/dataset/ldbc/small/temporal_query/IS4_cypher.txt");
    std::string is4_line;

    if (!is4_file.is_open())
    {
        std::cerr << "cannot openIS4_cypher.txt" << std::endl;
    }
    else
    {
    ...
    if (!is4_queries.empty())
    {
        ...
        auto duration_is4 = std::chrono::duration_cast<std::chrono::milliseconds>(end_time_is4 - start_time_is4);

        std::cout << "IS4query num: " << is4_queries.size() << std::endl;
        std::cout << "IS4exec time: " << duration_is4.count() << " ms" << std::endl;
        std::cout << "IS4avg query time: " << (double)duration_is4.count() / is4_queries.size() << " ms" << std::endl;
        std::cout << "IS4mem cost: " << (end_memory_is4 - start_memory_is4) / 1024.0 << " MB" << std::endl;
    }
    else
    {
        std::cout << "IS4dont have any query" << std::endl;
    }
    ...
    std::ifstream is5_file("/workspace/dataset/ldbc/small/temporal_query/IS5_cypher.txt");
    std::string is5_line;

    if (!is5_file.is_open())
    {
        std::cerr << "cannot openIS5_cypher.txt" << std::endl;
    }
    else
    {
    ...
    if (!is5_queries.empty())
    {
        ...
        auto duration_is5 = std::chrono::duration_cast<std::chrono::milliseconds>(end_time_is5 - start_time_is5);

        std::cout << "IS5query num: " << is5_queries.size() << std::endl;
        std::cout << "IS5exec time: " << duration_is5.count() << " ms" << std::endl;
        std::cout << "IS5avg query time: " << (double)duration_is5.count() / is5_queries.size() << " ms" << std::endl;
        std::cout << "IS5mem cost: " << (end_memory_is5 - start_memory_is5) / 1024.0 << " MB" << std::endl;
    }
    else
    {
        std::cout << "IS5dont have any query" << std::endl;
    }
    ...
    std::ifstream is6_file("/workspace/dataset/ldbc/small/temporal_query/IS6_cypher.txt");
    std::string is6_line;

    if (!is6_file.is_open())
    {
        std::cerr << "cannot openIS6_cypher.txt" << std::endl;
    }
    else
    {
    ...
    if (!is6_queries.empty())
    {
        ...
        auto duration_is6 = std::chrono::duration_cast<std::chrono::milliseconds>(end_time_is6 - start_time_is6);

        std::cout << "IS6query num: " << is6_queries.size() << std::endl;
        std::cout << "IS6exec time: " << duration_is6.count() << " ms" << std::endl;
        std::cout << "IS6avg query time: " << (double)duration_is6.count() / is6_queries.size() << " ms" << std::endl;
        std::cout << "IS6mem cost: " << (end_memory_is6 - start_memory_is6) / 1024.0 << " MB" << std::endl;
    }
    else
    {
        std::cout << "IS6dont have any query" << std::endl;
    }
    ...
    std::ifstream is7_file("/workspace/dataset/ldbc/small/temporal_query/IS7_cypher.txt");
    std::string is7_line;

    if (!is7_file.is_open())
    {
        std::cerr << "cannot openIS7_cypher.txt" << std::endl;
    }
    else
    {
    ...
    if (!is7_queries.empty())
    {
        ...
        auto duration_is7 = std::chrono::duration_cast<std::chrono::milliseconds>(end_time_is7 - start_time_is7);

        std::cout << "IS7query num: " << is7_queries.size() << std::endl;
        std::cout << "IS7exec time: " << duration_is7.count() << " ms" << std::endl;
        std::cout << "IS7avg query time: " << (double)duration_is7.count() / is7_queries.size() << " ms" << std::endl;
        std::cout << "IS7mem cost: " << (end_memory_is7 - start_memory_is7) / 1024.0 << " MB" << std::endl;
    }
    else
    {
        std::cout << "IS7dont have any query" << std::endl;
    }
